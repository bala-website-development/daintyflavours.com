      ...
      <div class="section-full bg-white content-inner-2">
        <div class="container">
          ...
          <div class="testimonial-one ">
            <Carousel autoPlay={this.props.deviceType !== "mobile" ? true : false} responsive={responsive}>
              <div class="testimonial-1">
                ...
                <div class="testimonial-pic radius">
                  <img src={require("./../../images/testimonials/pic1.jpg")} style={{ width: "100", height: "100" }} alt="" />
                </div>
