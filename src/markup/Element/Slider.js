            ...
            <>
              <div className="slideroverlay">
                ...
                <div className="text-center">
                  <Link className="dbtn-primary z-index" onClick={(e) => localStorage.setItem("queryurl", "maincategory=all&category=all")} to={{ pathname: "/shop?maincategory=all&category=all" }}>
                    Shop all
                  </Link>
