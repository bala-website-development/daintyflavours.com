                          ...
                          <div className="acod-content">
                            <div className="product-brand">
                              <div className="search-content">
                                ...
                                <label for="seating1" className="search-content-area">
                                  Burger
                                </label>
                              </div>
                              <div className="search-content">
                                <input id="seating2" type="checkbox" />
                                <label for="seating2" className="search-content-area">
                                  Pizza
                                </label>
                              </div>
                              <div className="search-content">
                                <input id="seating3" type="checkbox" />
                                <label for="seating3" className="search-content-area">
                                  Fries
                                </label>
                              </div>
                              <div className="search-content">
                                <input id="seating4" type="checkbox" />
                                <label for="seating4" className="search-content-area">
                                  Cola
                                </label>
                              </div>
                              <div className="search-content">
                                <input id="seating5" type="checkbox" />
                                <label for="seating5" className="search-content-area">
                                  Hotdog
                                </label>
                              </div>
                            </div>
                  ...
                  <div className="row">
                      ...
                      <div className="item-box shop-item style2">
                        ...
                        <div className="item-info text-center">
                          <h4 className="item-title">
                            <Link to={"/shop-product-details"}>Cup Cake</Link>
                          </h4>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-6 m-b30">
                      <div className="item-box shop-item style2">
                        ...
                        <div className="item-info text-center">
                          <h4 className="item-title">
                            <Link to={"/shop-product-details"}>Burger</Link>
                          </h4>
                          <h5 className="price text-primary">
                            <del>45</del>
                            <span>$40</span>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-6 m-b30">
                      <div className="item-box shop-item style2">
                        ...
                        <div className="item-info text-center">
                          `{" "}
                          <h4 className="item-title">
                            <Link to={"/shop-product-details"}>Chow Mein</Link>
                          </h4>
                          <h5 className="price text-primary">
                            <del>45</del>
                            <span>$40</span>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-6 m-b30">
                      <div className="item-box shop-item style2">
                        ...
                        <div className="item-info text-center">
                          <h4 className="item-title">
                            <Link to={"/shop-product-details"}>Chicken Breast</Link>
                          </h4>
                          <h5 className="price text-primary">
                            <del>45</del>
                            <span>$40</span>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-6 m-b30">
                      <div className="item-box shop-item style2">
                        ...
                        <div className="item-info text-center">
                          <h4 className="item-title">
                            <Link to={"/shop-product-details"}>Kurkure</Link>
                          </h4>
                          <h5 className="price text-primary">
                            <del>45</del>
                            <span>$40</span>
